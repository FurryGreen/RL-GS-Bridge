...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            elif args.gs_type == "gs_mesh" or args.gs_type == "gs_mesh_norm_aug":
                print("mesh eval:", args.eval)
                scene_info = sceneLoadTypeCallbacks["Colmap_single_mesh"](args.source_path, args.images, args.eval, args.num_splats[0])
            else:

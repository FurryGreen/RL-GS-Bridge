...
def training(gs_type, dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint,
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        if dataset.gs_type =='gs_mesh_norm_aug':
            Lpen = l2_loss(gaussians.soft_normalpha, 0) #soft惩罚项
            loss = (1.0 - opt.lambda_dssim) * Ll1 + opt.lambda_dssim * (1.0 - ssim(image, gt_image)) + 0.1*Lpen
        else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[7_000, 10_000, 20_000, 30_000, 60_000, 90_000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[7_000, 10_000, 20_000, 30_000, 60_000, 90_000])
